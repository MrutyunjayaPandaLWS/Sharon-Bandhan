...
//            self.header.setTitle("Terms and conditions", for: .normal)
...
//
//"""
//        }else if UserDefaults.standard.string(forKey: "LanguageLocalizable") == "2"{ self.header.setTitle("नियमएवंशर्तें", for: .normal)
...
//            self.header.setTitle("শর্তাবলী", for: .normal)
...
//"""
//        }else{
//            self.header.setTitle("నిబంధనలు&షరతులు", for: .normal)
